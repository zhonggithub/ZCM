...
class ZControl{
    constructor(element, dbConfig){
        ...
        this.setConfig(element, dbConfig);
    ...
    setConfig(element, dbConfig){
        this.element = element;
        this.dbConfig = dbConfig;
        this.dbProxy = new ZDBProxy(this.dbConfig);

        ZDBProxySingleton.getInstance().setDBConfig(dbConfig);
        ZDBProxySingleton.getInstance().setSchema(element.table, element.schema);

        //this.dbProxy.setSchema(element.table, element.schema);
    }
